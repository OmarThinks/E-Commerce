...
# python manage.py test users.tests.User_TestCase_02_DJOSER
class User_TestCase_02_DJOSER(TestCase):
	def setUp(self):
		pass
	...
	def test_01_make_sure_user_is_created(self):
		delete_all_records()
		expect_records(self,User,0)
		poplating_user_using_djoser()
		expect_records(self,User,1)
		print("test_01_make_sure_no_users")

	def test_02_djoser_token(self):
		populate_users(easy=False)
		expect_records(self,User,20)
		t = get_djoser_token("user_01","uncommon_01")
		self.assertEqual(type(t),str)
		print("test_02_djoser_token")
